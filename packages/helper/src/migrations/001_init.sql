...
-- Mirrors PRD section 8 (data model). Phase 1 subset:
-- conversations, messages, FTS, tags, capture_state, backfill_state, daily_stats.
-- Vector + embeddings + topic clusters land in a later migration.
...
-- Per-source ingest cursors (file offsets for jsonl tail-ingestion, etc.)
CREATE TABLE ingest_state (
  source_key   TEXT PRIMARY KEY,            -- e.g. "claude_code:<abs path>"
